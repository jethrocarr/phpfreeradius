...
#
# This script checks the current version of the database for the phpfreeradius application
...
if ($help)
{
	print "phpfreeradius Schema Management Utility\n";
	print "\n";
	print "Usage: schema_manage.pl --schemadir=<schemadir>\n";
	print "\n";
	print "-c, --cfgfile=FILENAME            phpfreeradius configuration file with MySQL settings.\n";
	print "\n";
