...
class page_output
{
	...
	function check_permissions()
	{
		if (user_online())
		{
			log_write("error", "page", "You are already logged in, there is no need to revisit the login page.");
			return 0;
		}
		else
		{
	...
	function execute()
	{
		...
		*/
		...
		// general
		$structure = NULL;
		$structure["fieldname"] 	= "username_phpfreeradius";
		$structure["type"]		= "input";
		$this->obj_form->add_input($structure);
		
		$structure = NULL;
		$structure["fieldname"] 	= "password_phpfreeradius";
