...
/*
	...
	Configure a new FreeRadius server to allow it to recieve configuration and push log to phpfreeradius.
*/
...
class page_output
{
	...
	{
		// title + summary
		print "<h3>ADD NEW RADIUS SERVER</h3><br>";
		print "<p>This page allows you to add a new FreeRadius server to the system and define the API access key for the server.</p>";
